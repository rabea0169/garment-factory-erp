...
الإعداد الافتراضي هو 30 طلباً لكل مسار، و10 عمال متزامنين، وبدون طلبات warm-up، ومهلة 10 ثوانٍ لكل طلب. يظل الحمل تحت حد rate limiter العام البالغ 100 طلب/دقيقة لكل IP أثناء تشغيل CI، ولا يُعطّل الحماية الأمنية لأجل القياس. هذه قيم تصميم للحمل وليست حدود قبول؛ يجب الاحتفاظ بها ثابتة عند مقارنة تشغيلين على بيئة متقاربة.
